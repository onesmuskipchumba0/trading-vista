...
function Footer() {
  return (
    <div className='flex flex-row items-center justify-center w-full p-4 gap-4 bg-gradient-to-br from-teal-500 via-blue-500 to-purple-500 shadow-md rounded-lg mt-4'>
        <div>
